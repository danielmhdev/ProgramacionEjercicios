...
//    Escribe un programa que muestre los números del 1 al 10, excepto los múltiplos de 3. Usa un bucle for con continue.
        ...
        for (int i = 1; i <= 10; i++) {
            if (i % 3 == 0) { // El modulo (%) si da 0, es múltiplo
                continue;
            }
...
//    Muestra las letras de la palabra "PROGRAMACION", pero omite las vocales usando continue.
        ...
        for (int i = 0; i < palabra.length(); i++) { // i < palabra.length() te da la longitud de la palabra
            char letra = palabra.charAt(i); // recorre un caracter
...
//    Intenta mostrar el carácter en esa posición usando try-catch. Si se produce un error, muestra un mensaje.
